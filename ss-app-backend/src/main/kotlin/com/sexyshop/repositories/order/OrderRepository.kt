...
interface OrderRepository {
    ...
    /** Para no crear dos pedidos si Mercado Pago avisa dos veces del mismo pago. */
    suspend fun getByMpPaymentId(mpPaymentId: String): Order?
    ...
    suspend fun marcarEntregado(id: String, receivedBy: String, proofUrl: String?, deliveredAt: String): Order
